if (process.env.NODE_ENV === 'production') {
  ...
  if (href.indexOf('welcome') >= 0) {} else {
    ...
    if (startRefreshCount < 2) {
      ...
      let weixinUrl =
        'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5d63c4a1990efe79&redirect_uri=https%3a%2f%2fwww.maywidehb.com%2fwebapp%2fdist%2f%23%2fwelcome%3froutepath%3dgame&response_type=code&scope=snsapi_userinfo&state=123#wechat_redirect';
